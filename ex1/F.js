...
function main() {
  ...
  function drawScene() {
    ...
    translation[1] += translationSpeed / 10.0;
  ...
  // Create separate translation matrices
  var translationMatrix = m3.translation(translation[0] + offsetX, translation[1] + offsetY);
